...
impl EpicFhirConfig {
    ...
    pub fn new(client_id: String, client_secret: String, auth_url: String, token_url: String, redirect_url: String, scopes: Vec<String>, audience: String) -> Self {
        Self { client_id, client_secret, auth_url, token_url, redirect_url, scopes, audience }
    }
}